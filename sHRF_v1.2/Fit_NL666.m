function [hrf, fit, e, param, aic, VM] = Fit_NL666(TC,STI)
...
%%%%%%%%%% Default parameters%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
V0 = [6 7 1 1 16 1 0];        % initial values for gamma functions
n_V= 6;     % number of parameters


LB = [0 2 0.5 0 6 0 -20];  %set the search lower bound 
UB = [15 10 2 10 25 1.5 20]; %set the search upper bound
